...
const TAGLINES: string[] = [
  ...
  "I don't judge, but your missing credentials are absolutely judging you.",
  ...
  "Telegram and Discord automation without the setup maze.",
  "One assistant, two chat channels, fewer surprises.",
