...
| Coordinate multiple agents                  | [Sub-agents](/tools/subagents)                 | [Agent send](/tools/agent-send)                                         |
...
| ---------------------- | ----------------------------------------------------------------------------- | ---------------------------------------------------------- | ---------------------------------------------------------------------- |
| Runtime                | Run commands or manage processes                                              | `exec`, `process`                                          | [Exec](/tools/exec)                                                    |
| Files                  | Read and change workspace files                                               | `read`, `write`, `edit`, `apply_patch`                     | [Apply patch](/tools/apply-patch)                                      |
| Web                    | Search the web through OpenAI-native search or fetch readable page content    | `web_search`, `web_fetch`                                  | [Web tools](/tools/web), [Web fetch](/tools/web-fetch)                 |
...
| Media                  | Analyze, generate, or speak media with OpenAI                                 | `image`, `image_generate`, `video_generate`, `tts`         | [Media overview](/tools/media-overview)                                |
